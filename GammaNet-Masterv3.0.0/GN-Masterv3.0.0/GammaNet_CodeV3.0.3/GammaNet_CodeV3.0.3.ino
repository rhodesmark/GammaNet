#include "core0_tasks.h" //Wifi Core0 System
...
if (core0On == "Yes"){
Serial.println(F("Allow Core 0 Tasks to Run"));
 startWiFiAPTask();
}
else{
 Serial.println(F(" Core 1 Tasks Not Allowed"));
 Serial.println(F(" Putting Core 0 into Deep Sleep")); 
}
...
xTaskCreatePinnedToCore(
 ...
 Serial.println(F(" Core 1 Tasks Not Allowed"));
 Serial.println(F(" Putting Core 1 into Deep Sleep")); 
}
...
void loop() {
    Serial.print("Running loop on core ");
